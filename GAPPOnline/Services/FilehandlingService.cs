...
namespace GAPPOnline.Services
{
    public class FileHandlingService : BaseService
    {
        ...
        public List<string> UploadFiles(HttpRequest request, string targetFolder, string targetFileName, int? maxFileSize = null)
        {
            ...
            for (int i = 0; i < request.Form.Files.Count; i++)
            {
                ...
                {
                    NotificationService.Instance.AddErrorMessage("Maximum file size exceeded.");
